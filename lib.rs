...
/*************************************************/
/*********  Change version details here **********/
/*************************************************/
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: ver_str!("basictest-node"),
	impl_name: ver_str!("basictest-node"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 1,
	apis: apis_vec!([
...
/*************************************************************/
/*********  Notify which components the Module uses **********/
/*************************************************************/		
		Basictest: basictest::{Module, Call, Storage},
	}
);
